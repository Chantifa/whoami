            ...
            >
                ...
                <Container>
                    <div className="motto text-center">
                        <h1>Rules</h1>
                        <p className="h3 mb-4">You have to learn the rules of the game. <br/> And then you have to play
                            better than
                    ...
                    <Container>
                        <Row>
                            <Col className="ml-auto mr-auto" md="12">
                                ...
                                <br/>
                                <img src="/img/mobile.png" alt="logo" width="150"/>
                            </Col>
                        </Row>
                                ...
                                <Card className="card-profile card-plain mt-5">
                                    <CardBody>
                                        ...
                                        <p className="card-description text-center">
                                            Players may ask any question that can be answered by Yes or No. Play is more
                                            fun and proceeds at
                            ...
                            <Col md="4">
                                <Card className="card-profile card-plain mt-5">
                                    <CardBody>
                                        ...
                                        <p className="card-description text-center">
                                            If you are a disney character then you might want to ask the following
                                            questions:
                                ...
                                <Card className="card-profile card-plain mt-5">
                                    <CardBody>
                                        ...
                                        <p className="card-description text-center">
                                            ...
                                            questions that will eliminate the widest amount. Big questions (like "Am I
                                            an animal?" or "Am I
                                            alive?") will
                                            get you to the point where you're able to steer your questions towards what
                                            you have confirmed so
                                            far
                                            about your answer.
                                        </p>
                                    </CardBody>
